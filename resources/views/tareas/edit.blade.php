...
<div class="max-w-xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
    <div class="bg-white dark:bg-gray-800 shadow-xl rounded-lg p-6">
        <h1 class="text-3xl font-bold mb-6 text-gray-900 dark:text-gray-100 flex items-center">
            <span class="mr-2">✏️</span> Editar Tarea
        </h1>

        <form action="{{ route('tareas.update', $tarea->tareas_id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-5">
                ...
                <div class="mt-1">
                    <input type="text" name="tareas_titulo" id="tareas_titulo" value="{{ $tarea->tareas_titulo }}" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                </div>
            </div>
            ...
            <div class="mb-5">
                ...
                <div class="mt-1">
                    <textarea name="tareas_descripcion" id="tareas_descripcion" rows="3" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ $tarea->tareas_descripcion }}</textarea>
                </div>
            </div>
            ...
            <div class="mb-5">
                ...
                <div class="mt-1">
                    <select name="estado_id" id="estado_id" required class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                        ...
                        <option value="{{ $estado->estado_id }}" {{ $tarea->estado_id == $estado->estado_id ? 'selected' : '' }}>
            ...
            @php
            // Asegurarnos de que tengamos un objeto Carbon o null
            $fecha_limite = $tarea->tareas_fecha_limite
            ? \Carbon\Carbon::parse($tarea->tareas_fecha_limite)->format('Y-m-d')
            : '';
            @endphp
            <!-- Fecha límite -->
            <div class="mb-5">
                ...
                <div class="mt-1">
                    <input type="date" name="tareas_fecha_limite" id="tareas_fecha_limite" value="{{ $fecha_limite }}" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                </div>
            </div>
            ...
            <div class="mb-5">
                ...
                <div class="mt-1">
                    <textarea name="tareas_notas" id="tareas_notas" rows="3" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ $tarea->tareas_notas }}</textarea>
                </div>
            </div>
