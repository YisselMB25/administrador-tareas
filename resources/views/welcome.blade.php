...
<head>
    ...
    <title>{{ config('app.name', 'Tarea') }}</title>
...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] flex p-6 lg:p-8 items-center lg:justify-center min-h-screen flex-col">
    <header class="w-full lg:max-w-4xl max-w-[335px] text-sm mb-6">
        ...
        <nav class="flex items-center justify-end gap-4">
            ...
            <a
                href="{{ url('/dashboard') }}"
                class="inline-block px-5 py-2 rounded-md text-sm font-medium transition-all duration-300 
                       bg-indigo-600 hover:bg-indigo-700 text-black
                       shadow-md hover:shadow-lg dark:bg-indigo-500 dark:hover:bg-indigo-600">
                Dashboard
            </a>
            @else
            <a
                ...
                class="inline-block px-5 py-2 rounded-md text-sm font-medium transition-all duration-300 
                       ...
                       shadow-md hover:shadow-lg dark:bg-green-500 dark:hover:bg-green-600">
                Iniciar Sesión
            </a>
            ...
            <a
                ...
                class="inline-block px-5 py-2 rounded-md text-sm font-medium transition-all duration-300 
                       ...
                       shadow-md hover:shadow-lg dark:bg-pink-500 dark:hover:bg-pink-600">
                Registro
            </a>
            @endif
            @endauth
    ...
    <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
            <!-- Texto -->
            <div class="text-[15px] leading-[22px] flex-1 p-6 pb-12 lg:p-20 
                        bg-white dark:bg-[#161615] dark:text-[#EDEDEC] 
                        shadow-lg rounded-bl-lg rounded-br-lg lg:rounded-tl-lg lg:rounded-br-none">
                <h1 class="mb-3 text-2xl font-bold text-indigo-900 dark:text-indigo-400">
                    Bienvenidos al sistema de Administración de Tareas
                </h1>
                <p class="mb-4 text-[#706f6c] dark:text-[#A1A09A]">
                    Este sistema permite a los usuarios registrarse e iniciar sesión. <br>
                    También administrar sus tareas o pendientes.
                </p>
            ...
            <div class="bg-[#fff2f2] dark:bg-[#1D0002] relative lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden flex items-center justify-center">
                {{-- Imagen manteniendo proporción --}}
                <img src="{{ asset('images/tarea.png') }}"
                    alt="Logo"
